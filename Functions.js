...
function showModal(pet_index){
    document.getElementById("pet_name").innerHTML = petarray[pet_index].name
    document.getElementById("description_pet").innerHTML = `${petarray[pet_index].name}, a ${petarray[pet_index].breed} ${petarray[pet_index].type}. 
                                                            ${petarray[pet_index].age} years old with ${petarray[pet_index].color} fur.`;
    document.getElementById("pet_type").innerHTML = `<span class="label">Type</span>: ${petarray[pet_index].type}`;                                                       
    document.getElementById("pet_sex").innerHTML = `<span class="label">Sex</span>: ${petarray[pet_index].sex}`;
    document.getElementById("pet_breed").innerHTML = `<span class="label">Breed</span>: ${petarray[pet_index].breed}`;
    document.getElementById("spayed_or_neutered_pet").innerHTML = `<span class="label">Spayed/Neutered</span>: ${petarray[pet_index].fixed}`;
    document.getElementById("pet_age").innerHTML = `<span class="label">Age</span>: ${petarray[pet_index].age}`;
    document.getElementById("status_pet").innerHTML = `<span class="label">Satus</span>: ${petarray[pet_index].status},`;
...
function updateCard(index) {
    ...
    if (cardElement) {
        let age = block_number_icons[petarray[index].age];
        let sex = (petarray[index].sex == "Male") ?
        ...
        let htmlContent = `
            <img src="${petarray[index].image}" class="card-img-top" alt="Image of ${petarray[index].name}">
            <div class="card-body">
                <h5 class="card-title">${petarray[index].name}</h5>
                <div>${sex}${age}</div><br />
